    ...
    for j in range(2):
        for k in range(3):
            ...
            if show_matrix:
                ...
                # This is code for getting a colorbar. Not so useful in the combined plot, but can be used if matrices
            ...
            ax[j, k].plot(np.array([AFP.CA_parms[c].ballistic_impact_angle, AFP.CA_parms[c].ballistic_impact_angle]),
