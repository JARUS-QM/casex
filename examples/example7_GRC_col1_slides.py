...
Example 7
---------
Slide distance for column 1 in GRC
MISSING DOC
"""
...
def example7_GRC_col1_slides():
    ...
    # No reduction
    p.append(CA.critical_area(casex.enums.CriticalAreaModel.JARUS, aircraft, impact_speed, impact_angle,
                              critical_areas_overlap))
