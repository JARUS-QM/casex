...
is 10 m^2. Therefore, the iso-curve for to 10 m^2 is shown (in yellow) along with other iso curves for comparison (in white).

The purpose is to give a relation between angle and speed for impacts to uncovered any potential relation between angle and
speed in terms of fixed lethal area.
