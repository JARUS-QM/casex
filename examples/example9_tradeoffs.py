...
Note that this example does account for the 0.3 reduction in iGRC described in the Annex, but it does not
account for the reduction due to obstacles applicable for some population densities.
"""
