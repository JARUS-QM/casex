...
for j in range(7):
    ax.text(x_text_pos[0], y_text_pos[j], str(j+1+int(j > 0) - int(j == 6)), horizontalalignment='center', verticalalignment='center', fontsize=GRC_fontsize, color=GRC_color)
    if j < 6:
        for k in range(4):
            ax.text(x_text_pos[k+1], y_text_pos[j], str(j+2+k+int(j > 0)), horizontalalignment='center', verticalalignment='center', fontsize=GRC_fontsize, color=GRC_color)
    ax.text(wingspan[-1]*1.05, y_text_pos[j], str(pop_dens_percentage[j]) + '%', horizontalalignment='center', verticalalignment='center', fontsize=GRC_fontsize)
ax.text(wingspan[-1]*1.05, 3.2 * 0.0005, 'DK dens', horizontalalignment='center', verticalalignment='center', fontsize=GRC_fontsize)
